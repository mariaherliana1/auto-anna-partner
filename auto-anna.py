...
def __main__():
    ...
    for files in CONFIG:
        ...
        # Pass the client value from the current configuration
        call_details = process_dashboard_csv(files.dashboard, client=files.client)
        
        # Process the console CSV
        call_details = process_console_csv(files.console, call_details)
