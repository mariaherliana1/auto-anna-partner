...
def process_dashboard_csv(
    file_path: str, call_details: Optional[dict[str, CallDetail]] = None, client: str = ""
) -> dict[str, CallDetail]:
...
def process_console_csv(
    file_path: str, call_details: dict[str, CallDetail], client: str = ""
) -> dict[str, CallDetail]:
    ...
    call_type_mapping = {
        ...
        "OUTGOING_TRANSFER": "Outbound forwarding",
    }
